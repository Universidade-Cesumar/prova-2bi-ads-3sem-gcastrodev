...
| Elemento                         | Seletor              |
| -------------------------------- | -------------------- |
| Input de nome do material        | `#input-nome`        |
| Input de quantidade              | `#input-quantidade`  |
| Botão de cadastrar               | `#btn-cadastrar`     |
| Tabela/lista de materiais        | `#lista-materiais`   |
| Input de quantidade a retirar    | `#input-retirada`    |
| Botão de baixa (PUT)             | `.btn-baixar`        |
| Botão de exclusão (DELETE)       | `.btn-excluir`       |
